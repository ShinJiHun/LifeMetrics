...
export default function ActivityDetailPage() {
    ...
    const stats = [
        ...
        {label: "평균파워", val: activity.avgPower ? `${Math.round(activity.avgPower)} W` : "-"},
    ];
                        ...
                        <div style={{overflowX: "auto"}}>
                            <table style={S.table}>
                                ...
                                <tr style={S.thead}>
                                    ...
                                    <th style={{...S.th, textAlign: "right"}}>파워(avg/max)</th>
                                        ...
                                        <td style={{...S.td, textAlign: "right"}}>
                                            {seg.avgPower ? (
                                                <span>
                                                    ...
                                                    {seg.maxPower ? <span style={{
                                                        color: "#64748b",
                                                        fontSize: 11
                                                    }}> / {Math.round(seg.maxPower)}</span> : ""} W
                                                 </span>
                                            ) : "-"}
                                        </td>
                                        <td style={{...S.td, textAlign: "right"}}>
